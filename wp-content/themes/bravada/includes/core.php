...
function bravada_master_footer() {
	...
	echo 'Bravada WordPress Theme by ' . 'Cryout Creations"> ' . '301' .'</a> &amp; <a target="_blank" href="' . "http://wordpress.org/";
	echo '" title="' . esc_attr__( "Semantic Personal Publishing Platform", "bravada") . '"> ' . sprintf( " %s", "你的蒙" ) . '</a></div>';
}
